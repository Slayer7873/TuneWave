...
public class MusicPlayerActivity extends AppCompatActivity {
        ...
        MusicPlayerActivity.this.runOnUiThread(new Runnable() {
            ...
            public void run() {
                if(mediaPlayer!=null){
                    ...
                    currentTimeTv.setText(convertTomiliSeconds(mediaPlayer.getCurrentPosition()+""));
    ...
    void setResourcesWithMusic(){
        ...
        totalTimeTv.setText(convertTomiliSeconds(currentSong.getDuration()));
    ...
    public static String convertTomiliSeconds(String duration) {
